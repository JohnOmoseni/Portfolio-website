...
function Column1() {
	return (
		...
		>
			<motion.p
				className="tagline fs-small ff-variant"
				variants={animateTagLine}
			>
			...
			<motion.p className="text fw-semi-bold" variants={animateSubtitle}>
				As a frontend software developer, I understand the importance of
			...
			<motion.a
				href="#contact"
				className="banner-btn fw-semi-bold"
				variants={animateBtn}
			>
				Connect with me!
			</motion.a>
